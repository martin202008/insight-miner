...
export function ContentPreview({ result, isLoading }: ContentPreviewProps) {
  ...
  useEffect(() => {
    console.log("[ContentPreview] result updated:", JSON.stringify(result, null, 2));
  }, [result]);
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">内容生成中...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="p-4 bg-card border border-border rounded-lg text-sm whitespace-pre-wrap">
          {result.content}
        </div>
      </div>
